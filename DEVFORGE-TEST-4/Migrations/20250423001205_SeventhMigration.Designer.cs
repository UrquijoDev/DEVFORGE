...
namespace DEVFORGE_TEST_4.Migrations
{
    ...
    [Migration("20250423001205_SeventhMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DEVFORGE_TEST_4.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DEVFORGE_TEST_4.Models.Feature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DEVFORGE_TEST_4.Models.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DEVFORGE_TEST_4.Models.UserProject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DEVFORGE_TEST_4.Models.Feature", b =>
                {
                    b.HasOne("DEVFORGE_TEST_4.Models.ServicePlan", "ServicePlan")
                        .WithMany("Features")
            ...
            modelBuilder.Entity("DEVFORGE_TEST_4.Models.UserProfile", b =>
                {
                    b.HasOne("DEVFORGE_TEST_4.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("DEVFORGE_TEST_4.Models.UserProject", b =>
                {
                    ...
                    b.HasOne("DEVFORGE_TEST_4.Models.UserProfile", "UserProfile")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DEVFORGE_TEST_4.Models.ApplicationUser", null)
                        .WithMany()
